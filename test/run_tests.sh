...
declare -A params=( ["${tests[0]}"]="$OK -t Minimization of the reference DFA"
                    ...
                    ["${tests[34]}"]="$OK -t Minimization"
                    ["${tests[35]}"]="$OK -t DFA: 1 state, no transitions"
                    ["${tests[36]}"]="$OK -t DFA: 1 state, No final, no transitions"
                    ["${tests[37]}"]="$OK -t DFA: 1 state, No final, full transitions"
)
